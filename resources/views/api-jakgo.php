...
<a href="http://api-jakgo.fzlrhmn.com/api/v1/kelurahan?api_token=q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk&amp;shape=true">api-jakgo.fzlrhmn.com/api/v1/kelurahan?api_token=q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk&amp;shape=true</a></p>
<section id="" class="resource-group"><h2 class="group-heading">Resource Group <a href="#" class="permalink">&para;</a></h2><div id="kota" class="resource"><h3 class="resource-heading">Kota <a href="#kota" class="permalink">&nbsp;&para;</a></h3><div id="kota-get" class="action get"><h4 class="action-heading"><div class="name">Data Kota</div><a href="#kota-get" class="method get">GET</a><code class="uri">/api/v1/kota/{kode_kota}?api_token={api_token}&amp;shape={shape}&amp;format={format}</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://api-jakgo.fzlrhmn.com/</span>/api/v1/kota/<span class="hljs-attribute" title="kode_kota">3174</span>?api_token=<span class="hljs-attribute" title="api_token">q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span>&shape=<span class="hljs-attribute" title="shape">true</span>&format=<span class="hljs-attribute" title="format">geojson</span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>kode_kota</dt><dd><code>array</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>3174</span></span><p>kode_kota of the kota (city) itself. use comma without whitespace if want to get more than one data, i.e ‘3174,3175’.</p>
...
</dd><dt>shape</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>true</span></span><p>String if true that geometry in WKT string of Kota will include in API.</p>
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="kecamatan" class="resource"><h3 class="resource-heading">Kecamatan <a href="#kecamatan" class="permalink">&nbsp;&para;</a></h3><div id="kecamatan-get" class="action get"><h4 class="action-heading"><div class="name">Data Kecamatan</div><a href="#kecamatan-get" class="method get">GET</a><code class="uri">/api/v1/kecamatan/{kode_kecamatan}?api_token={api_token}&amp;shape={shape}&amp;format={format}</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://api-jakgo.fzlrhmn.com/</span>/api/v1/kecamatan/<span class="hljs-attribute" title="kode_kecamatan">3175060</span>?api_token=<span class="hljs-attribute" title="api_token">q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span>&shape=<span class="hljs-attribute" title="shape">true</span>&format=<span class="hljs-attribute" title="format">geojson</span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>kode_kecamatan</dt><dd><code>array</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>3175060</span></span><p>kode_kecamatan of the kecamatan itself, use comma without whitespace if want to get more than one data, i.e ‘3172040,3172050’.</p>
</dd><dt>format</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>geojson</span></span><p>String of the response format that the response will show.</p>
</dd><dt>shape</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>true</span></span><p>String if true that geometry in WKT string of kecamatan will include in API.</p>
</dd><dt>api_token</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span></span><p>String <code>api_token</code> of the application.</p>
</dd></dl></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"success"</span></span>,
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="kelurahan" class="resource"><h3 class="resource-heading">Kelurahan <a href="#kelurahan" class="permalink">&nbsp;&para;</a></h3><div id="kelurahan-get" class="action get"><h4 class="action-heading"><div class="name">Data Kelurahan</div><a href="#kelurahan-get" class="method get">GET</a><code class="uri">/api/v1/kelurahan/{kode_kelurahan}?api_token={api_token}&amp;shape={shape}&amp;format={format}</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://api-jakgo.fzlrhmn.com/</span>/api/v1/kelurahan/<span class="hljs-attribute" title="kode_kelurahan">3174020007</span>?api_token=<span class="hljs-attribute" title="api_token">q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span>&shape=<span class="hljs-attribute" title="shape">true</span>&format=<span class="hljs-attribute" title="format">geojson</span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>kode_kelurahan</dt><dd><code>array</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>3174020007</span></span><p>kode_kelurahan of the kota (city) itself. use comma without whitespace if want to get more than one data, i.e ‘3174020007,3174020006’.</p>
</dd><dt>format</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>geojson</span></span><p>String of the response format that the response will show.</p>
</dd><dt>shape</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>true</span></span><p>String if true that geometry in WKT string of Kelurahan will include in API.</p>
</dd><dt>api_token</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span></span><p>String <code>api_token</code> of the application.</p>
</dd></dl></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"success"</span></span>,
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="rw" class="resource"><h3 class="resource-heading">RW <a href="#rw" class="permalink">&nbsp;&para;</a></h3><div id="rw-get" class="action get"><h4 class="action-heading"><div class="name">Data RW</div><a href="#rw-get" class="method get">GET</a><code class="uri">/api/v1/rw/{kode_rw}?api_token={api_token}&amp;shape={shape}&amp;format={format}&amp;page={page}</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://api-jakgo.fzlrhmn.com/</span>/api/v1/rw/<span class="hljs-attribute" title="kode_rw">3174070005001000</span>?api_token=<span class="hljs-attribute" title="api_token">q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span>&shape=<span class="hljs-attribute" title="shape">true</span>&format=<span class="hljs-attribute" title="format">geojson</span>&page=<span class="hljs-attribute" title="page">1</span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>kode_rw</dt><dd><code>array</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>3174070005001000</span></span><p>kode_rw of the kota (city) itself. use comma without whitespace if want to get more than one data, i.e ‘3174070005001000,3174070005002000’.</p>
</dd><dt>format</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>geojson</span></span><p>String of the response format that the response will show.</p>
</dd><dt>shape</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>true</span></span><p>String if true that geometry in WKT string of RW will include in API.</p>
</dd><dt>api_token</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span></span><p>String <code>api_token</code> of the application.</p>
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="tps" class="resource"><h3 class="resource-heading">TPS <a href="#tps" class="permalink">&nbsp;&para;</a></h3><div id="tps-get" class="action get"><h4 class="action-heading"><div class="name">Data TPS</div><a href="#tps-get" class="method get">GET</a><code class="uri">/api/v1/tps/{id}?api_token={api_token}&amp;shape={shape}&amp;format={format}&amp;page={page}</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://api-jakgo.fzlrhmn.com/</span>/api/v1/tps/<span class="hljs-attribute" title="id">1</span>?api_token=<span class="hljs-attribute" title="api_token">q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span>&shape=<span class="hljs-attribute" title="shape">true</span>&format=<span class="hljs-attribute" title="format">geojson</span>&page=<span class="hljs-attribute" title="page">1</span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>id</dt><dd><code>array</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>1</span></span><p>id of the TPS itself. use comma without whitespace if want to get more than one data, i.e ‘1,2’.</p>
</dd><dt>format</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>geojson</span></span><p>String of the response format that the response will show.</p>
</dd><dt>shape</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>true</span></span><p>String if true that geometry in WKT string of TPS will include in API.</p>
</dd><dt>api_token</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span></span><p>String <code>api_token</code> of the application.</p>
</dd><dt>page</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>1</span></span><p>Number of page that show. This API show 200 RW per call.</p>
</dd></dl></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="rumah-sakit-umum" class="resource"><h3 class="resource-heading">Rumah Sakit Umum <a href="#rumah-sakit-umum" class="permalink">&nbsp;&para;</a></h3><div id="rumah-sakit-umum-get" class="action get"><h4 class="action-heading"><div class="name">Data Rumah Sakit Umum</div><a href="#rumah-sakit-umum-get" class="method get">GET</a><code class="uri">/api/v1/rumahsakitumum/{id}?api_token={api_token}&amp;shape={shape}&amp;format={format}</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://api-jakgo.fzlrhmn.com/</span>/api/v1/rumahsakitumum/<span class="hljs-attribute" title="id">1</span>?api_token=<span class="hljs-attribute" title="api_token">q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span>&shape=<span class="hljs-attribute" title="shape">true</span>&format=<span class="hljs-attribute" title="format">geojson</span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>id</dt><dd><code>array</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>1</span></span><p>id of the Rumah Sakit Umum (Hospital) itself. use comma without whitespace if want to get more than one data, i.e ‘1,2’.</p>
</dd><dt>format</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>geojson</span></span><p>String of the response format that the response will show.</p>
</dd><dt>shape</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>true</span></span><p>String if true that geometry in WKT string of Rumah Sakit Umum will include in API.</p>
</dd><dt>api_token</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span></span><p>String <code>api_token</code> of the application.</p>
</dd></dl></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"success"</span></span>,
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="rumah-sakit-khusus" class="resource"><h3 class="resource-heading">Rumah Sakit Khusus <a href="#rumah-sakit-khusus" class="permalink">&nbsp;&para;</a></h3><div id="rumah-sakit-khusus-get" class="action get"><h4 class="action-heading"><div class="name">Data Rumah Sakit Khusus</div><a href="#rumah-sakit-khusus-get" class="method get">GET</a><code class="uri">/api/v1/rumahsakitkhusus/{id}?api_token={api_token}&amp;shape={shape}&amp;format={format}</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://api-jakgo.fzlrhmn.com/</span>/api/v1/rumahsakitkhusus/<span class="hljs-attribute" title="id">1</span>?api_token=<span class="hljs-attribute" title="api_token">q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span>&shape=<span class="hljs-attribute" title="shape">true</span>&format=<span class="hljs-attribute" title="format">geojson</span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>id</dt><dd><code>array</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>1</span></span><p>id of the Rumah Sakit Khusus (Hospital) itself. use comma without whitespace if want to get more than one data, i.e ‘1,2’.</p>
</dd><dt>format</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>geojson</span></span><p>String of the response format that the response will show.</p>
</dd><dt>shape</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>true</span></span><p>String if true that geometry in WKT string of Rumah Sakit Khusus will include in API.</p>
</dd><dt>api_token</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span></span><p>String <code>api_token</code> of the application.</p>
</dd></dl></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"success"</span></span>,
  "<span class="hljs-attribute">count</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div><div id="puskesmas" class="resource"><h3 class="resource-heading">Puskesmas <a href="#puskesmas" class="permalink">&nbsp;&para;</a></h3><div id="puskesmas-get" class="action get"><h4 class="action-heading"><div class="name">Puskesmas</div><a href="#puskesmas-get" class="method get">GET</a><code class="uri">/api/v1/puskesmas/{id}?api_token={api_token}&amp;shape={shape}&amp;format={format}</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">http://api-jakgo.fzlrhmn.com/</span>/api/v1/puskesmas/<span class="hljs-attribute" title="id">1</span>?api_token=<span class="hljs-attribute" title="api_token">q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span>&shape=<span class="hljs-attribute" title="shape">true</span>&format=<span class="hljs-attribute" title="format">geojson</span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>id</dt><dd><code>array</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>1</span></span><p>id of the Puskesmas (Hospital) itself. use comma without whitespace if want to get more than one data, i.e ‘1,2’.</p>
</dd><dt>format</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>geojson</span></span><p>String of the response format that the response will show.</p>
</dd><dt>shape</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>true</span></span><p>String if true that geometry in WKT string of Puskesmas will include in API.</p>
</dd><dt>api_token</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>q06qb1eTOimT7sc9nMQfkzCKBYEzePXwYbWpEaEk</span></span><p>String <code>api_token</code> of the application.</p>
</dd></dl></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">status</span>": <span class="hljs-value"><span class="hljs-string">"success"</span></span>,
  "<span class="hljs-attribute">count</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
